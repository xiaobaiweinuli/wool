...
def download_so_file(filename, py_v, cpu_info, main_url):
    ...
    if cpu_info in ['aarch64', 'armv8']:
        url = f'{main_url}/{file_base_name}_3{py_v}_aarch64.so'
    if cpu_info == 'x86_64':
        url = f'{main_url}/{file_base_name}_3{py_v}_{cpu_info}.so'
    # print(github_url)
    # 您的命令，使用 -# 参数显示下载进度
    ...
    elif main_url != 'https://files.doudoudou.fun/?f=/script/others':
